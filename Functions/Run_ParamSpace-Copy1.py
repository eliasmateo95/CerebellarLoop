...
#     print('zebrin_ff',zebrin_ff)
#     print('PC',PC_Values["I_intrinsic"])
...
#         print(w_IO_DCN_val)
        ...
        ###################################################################
        DCN_IO_Synapse_Coupled = DCN_IO_syn(DCN_Coupled,IO_Coupled,N_Cells_DCN,N_Cells_IO,w_IO_DCN_val,dt,dt_rec)
...
#     print(f'gcal {gCal_values/(mS/cm**2)}')
    ...
    IO.sigma_OU = sigma_ou*unit_I# 0.05*uA/cm**2
    IO_Coupled.sigma_OU = sigma_ou*unit_I# 0.05*uA/cm**2

    IO.I_OU = b_OU*unit_I
    IO.I0_OU = b_OU*unit_I
    IO_Coupled.I_OU = b_OU*unit_I
    IO_Coupled.I0_OU = b_OU*unit_I
