...
PC_Statemon_Coupled_noSTDP = StateMonitor(PC_Coupled_noSTDP, ['v', 'w', 'I_Noise','I_intrinsic','tauw'], record=True,dt=dt_rec)
...
#####################################################################
IO_Coupled_noSTDP = NeuronGroup(N_Cells_IO, model = eqs_IO, threshold='Vs>20*mV' , method = 'euler',name = 'SchweighoferOlive_Coupled_noSTDP',dt=dt)
...
IO_Statemon_Coupled_noSTDP = StateMonitor(IO_Coupled_noSTDP, variables = ['Vs','Vd', 'I_IO_DCN','I_c'], record = True, dt=dt_rec)
...
######### Monitors ###############
DCN_Statemon_Coupled_noSTDP = StateMonitor(DCN_Coupled_noSTDP, ['v', 'I_PC','w'], record=True,dt=dt_rec)
...
PC_Statemon_Uncoupled_noSTDP = StateMonitor(PC_Uncoupled_noSTDP, ['v', 'w', 'I_Noise','I_intrinsic','tauw'], record=True,dt=dt_rec)
...
IO_Statemon_Uncoupled_noSTDP = StateMonitor(IO_Uncoupled_noSTDP, variables = ['Vs','Vd', 'I_IO_DCN','I_c'], record = True, dt=dt_rec)
...
######### Monitors ###############
DCN_Statemon_Uncoupled_noSTDP = StateMonitor(DCN_Uncoupled_noSTDP, ['v', 'I_PC','w'], record=True,dt=dt_rec)
