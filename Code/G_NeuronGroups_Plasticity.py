...
PC_Statemon_Coupled_STDP = StateMonitor(PC_Coupled_STDP, ['v', 'w', 'I_Noise','I_intrinsic','tauw'], record=True,dt=dt_rec)
...
IO_Statemon_Coupled_STDP = StateMonitor(IO_Coupled_STDP, variables = ['Vs','Vd','I_IO_DCN', 'I_c'], record = True, dt=dt_rec)
...
######### Monitors ###############
DCN_Statemon_Coupled_STDP = StateMonitor(DCN_Coupled_STDP, ['v', 'I_PC','w'], record=True,dt=dt_rec)
...
PC_Statemon_Uncoupled_STDP = StateMonitor(PC_Uncoupled_STDP, ['v', 'w', 'I_Noise'], record=True,dt=dt_rec)
...
IO_Statemon_Uncoupled_STDP = StateMonitor(IO_Uncoupled_STDP, variables = ['Vs','Vd', 'I_IO_DCN','I_c'], record = True, dt=dt_rec)
...
######### Monitors ###############
DCN_Statemon_Uncoupled_STDP = StateMonitor(DCN_Uncoupled_STDP, ['v', 'I_PC','w'], record=True,dt=dt_rec)
