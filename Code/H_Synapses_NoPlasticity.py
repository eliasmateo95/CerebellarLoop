from G_NeuronGroups_NoPlasticity import *
...
S_Coupled_noSTDP.noise_weight = 'abs(1.0-abs(i-j)/N_Cells_PC)'
S_statemon = StateMonitor(S_Coupled_noSTDP, variables=['noise_weight','I_Noise'], record=True,dt=dt_rec)
...
S_Uncoupled_noSTDP.noise_weight = 'abs(1.0-abs(i-j)/N_Cells_PC)'
S_statemon = StateMonitor(S_Uncoupled_noSTDP, variables=['noise_weight','I_Noise'], record=True,dt=dt_rec)
...
IO_synapse_Uncoupled_noSTDP = Synapses(IO_Uncoupled_noSTDP, IO_Uncoupled_noSTDP, eqs_IO_syn_Uncoupled_noSTDP, name = 'IO_Synapse_Uncoupled_noSTDP',dt=dt)
